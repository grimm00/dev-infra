...
1. **From Exploration (`--from-explore`):**
   - Read `docs/maintainers/planning/explorations/[explore-topic]/research-topics.md`
...
**Location:** `docs/maintainers/research/[topic]/`
...
**File:** `docs/maintainers/research/README.md` (create if doesn't exist)
