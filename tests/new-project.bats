...
# ============================================================================
# Template Name Tests (TDD for standard-project)
# ============================================================================

@test "template_name: standard-project template path resolves correctly" {
...
@test "template_name: regular-project template no longer exists" {
...
@test "template_name: both template types available" {
