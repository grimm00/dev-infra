...
|---------|----------|-----------------|
| **dev-infra** | N/A | Templates, patterns, Cursor AI commands |
...
**Key Insight:** These four projects each have distinct responsibilities, but work together to provide a complete development experience.
