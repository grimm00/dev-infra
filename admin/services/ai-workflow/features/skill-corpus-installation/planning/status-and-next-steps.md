...
| Installer Script | 🟠 In Progress | 2/5 tasks | Tasks 11–12 ✅ install + `--uninstall` (`agentic-ocean` feat/installer-script; 8 Bats). Next: Task 13 standard flags |
