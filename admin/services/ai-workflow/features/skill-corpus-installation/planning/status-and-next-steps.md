...
| Installer Script | 🟠 In Progress | 3/5 tasks | Tasks 11–13 ✅ install + `--uninstall` + flags (`agentic-ocean` feat/installer-script; 12 Bats). Next: Task 14 core→personal lint |
