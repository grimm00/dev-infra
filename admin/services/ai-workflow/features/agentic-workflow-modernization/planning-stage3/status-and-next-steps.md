...
- decision skill: Group 1 complete; Group 3 adds assets/ template extraction + references/structure.yaml
...
- Task count increased 12 → 15: Group 3 inserts 3 restructuring tasks between write-plan and plan-review
