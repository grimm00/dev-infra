...
- [ ] Task 9: Convert plan-review to SKILL.md
  - Procedural skill — likely the simplest Stage 3 conversion
...
1. Complete the Planner role group with the simplest conversion
2. Maintain review quality from command era
