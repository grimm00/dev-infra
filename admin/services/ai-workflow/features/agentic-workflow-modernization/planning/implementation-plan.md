...
- [ ] Task 1: Audit current `.mdc` rules content and classify by destination (four-type separation per FR-4)
- [ ] Task 2: Draft AGENTS.md with portable conventions (~150-200 lines, FR-1 inline)
