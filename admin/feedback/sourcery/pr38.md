...
|---------|----------|--------|--------|-------|
| #1 | 🟡 MEDIUM | 🟢 LOW | 🟢 LOW | Deferred - Test assertion precision for undefined vars |
| #2 | 🟡 MEDIUM | 🟡 MEDIUM | 🟢 LOW | Deferred - Test assertion clarity for file collision |
| Overall-1 | 🟡 MEDIUM | 🟢 LOW | 🟢 LOW | Deferred - Same as #2, tighten existing file assertion |
| Overall-2 | 🟡 MEDIUM | 🟢 LOW | 🟢 LOW | Deferred - Tighten assertions in gh CLI and path expansion tests |
