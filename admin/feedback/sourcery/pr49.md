...
|---------|----------|--------|--------|-------|
| #1 | 🟠 HIGH | 🟠 HIGH | 🟢 LOW | Bug risk with `set -u` - **Fix now** |
| #2 | 🟡 MEDIUM | 🟡 MEDIUM | 🟡 MEDIUM | TDD placeholder assertions - Defer |
| #3 | 🟡 MEDIUM | 🟡 MEDIUM | 🟢 LOW | ✅ Fixed in PR #50 (test-assertion-improvements-medium-low-01) |
| #4 | 🟡 MEDIUM | 🟡 MEDIUM | 🟡 MEDIUM | Missing edge case tests - Defer |
