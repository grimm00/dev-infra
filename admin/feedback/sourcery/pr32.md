...
| #2 | 🟠 HIGH | 🟡 MEDIUM | 🟢 LOW | Bug: "skipping" message but still fails - Missing gh CLI causes false failures. Should return 0 for skipped checks. Fix now. |
...
| #6 | 🟡 MEDIUM | 🟢 LOW | 🟢 LOW | ✅ Fixed in fix/pr32-batch-medium-low-01 - Phase 1 completion criteria boxes now checked |
