...
v0.5.0 was the first release to use the new Release Automation v2 features. This document captures learnings from the release process itself, including automatic tag creation and version reference automation.
...
- Tag `v0.5.0` created within seconds of merge
...
**What the problem was:**
Some tests depend on real repository state (v0.4.0 version) and will fail when version changes.
...
- First automated release: ✅ Success
...
- [RELEASE-COMPLETE.md](../../../releases/v0.5.0/RELEASE-COMPLETE.md)
- [RELEASE-NOTES.md](../../../releases/v0.5.0/RELEASE-NOTES.md)
