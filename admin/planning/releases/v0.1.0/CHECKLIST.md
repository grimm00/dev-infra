...
- [x] Update CHANGELOG.md from 0.1.0 to 0.1.0
- [x] Add release date and version information
- [x] Update version history section
- [x] Add breaking changes section (none for v0.1.0)
- [x] Add deprecations section (none for v0.1.0)
- [x] Update security, performance, and dependencies sections

### Release Documentation
- [x] Create release overview in admin/planning/releases/v0.1.0/README.md
...
- [x] Create release/v0.1.0 branch from develop
...
- [x] Low priority items deferred to v0.1.1
...
### Cleanup
- [ ] Delete release/v0.1.0 branch locally
- [ ] Delete release/v0.1.0 branch on GitHub
