...
v0.5.0 is an **internal-only release** focused on automating release workflows. This release delivers **Release Automation v2**, a two-phase enhancement that eliminates manual steps from the release process.
...
2. GitHub Actions extracts version from branch name (`release/v0.5.0`)
...
**Example:**
```bash
# Update version references from v0.4.0 to v0.5.0
./scripts/update-version-references.sh --old-version v0.4.0 --new-version v0.5.0

# Dry-run to preview changes
./scripts/update-version-references.sh --old-version v0.4.0 --new-version v0.5.0 --dry-run

# Verbose output for debugging
./scripts/update-version-references.sh --old-version v0.4.0 --new-version v0.5.0 --verbose
```
...
Starting with v0.5.0, the release process includes automated steps:
...
**Full Changelog:** [v0.4.0...v0.5.0](https://github.com/grimm00/dev-infra/compare/v0.4.0...v0.5.0)
...
**Next Release:** v0.6.0 (Considerations: Experimental template, command branch workflow)
