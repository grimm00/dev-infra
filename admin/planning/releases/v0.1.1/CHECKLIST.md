...
- [x] Update CHANGELOG.md from 0.1.0 to 0.1.1
- [x] Add release date and version information
- [x] Update version history section
- [x] Add breaking changes section (none for v0.1.1)
- [x] Add deprecations section (none for v0.1.1)
- [x] Update security, performance, and dependencies sections
- [x] Update README.md version references

### Release Documentation
- [x] Create release overview in admin/planning/releases/v0.1.1/README.md
- [x] Create release notes in admin/planning/releases/v0.1.1/RELEASE-NOTES.md
...
### README Updates
- [x] Update version number to v0.1.1
- [x] Update download URLs to v0.1.1
...
- [x] Create release/v0.1.1 branch from develop
...
### GitHub Release
- [ ] Create GitHub release from v0.1.1 tag
...
### Cleanup
- [ ] Delete release/v0.1.1 branch locally
- [ ] Delete release/v0.1.1 branch on GitHub
