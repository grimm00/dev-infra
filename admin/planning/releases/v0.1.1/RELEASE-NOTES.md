...
- `dev-infra-0.1.1.tar.gz` - Clean distribution (Linux/Mac)
- `dev-infra-0.1.1.tar.gz.sha256` - Checksum
- `dev-infra-0.1.1.zip` - Clean distribution (Windows)
- `dev-infra-0.1.1.zip.sha256` - Checksum
...
curl -L https://github.com/grimm00/dev-infra/releases/download/v0.1.1/dev-infra-0.1.1.tar.gz | tar -xz
cd dev-infra-0.1.1
...
curl -L https://github.com/grimm00/dev-infra/releases/download/v0.1.1/dev-infra-0.1.1.tar.gz.sha256 -o dev-infra-0.1.1.tar.gz.sha256
sha256sum -c dev-infra-0.1.1.tar.gz.sha256
```
...
curl -L "https://github.com/grimm00/dev-infra/archive/v0.1.0.tar.gz" | tar -xz
