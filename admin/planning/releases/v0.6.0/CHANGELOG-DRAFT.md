...
## Note: v0.5.0 CHANGELOG

⚠️ The v0.5.0 CHANGELOG entries were updated on the release branch but not merged back to develop. These entries should be included when merging this release.

**v0.5.0 Features (already released 2025-12-12):**
