...
- `dev-infra-1.2.0.tar.gz` - Clean distribution (Linux/Mac)
- `dev-infra-1.2.0.tar.gz.sha256` - Checksum
- `dev-infra-1.2.0.zip` - Clean distribution (Windows)
- `dev-infra-1.2.0.zip.sha256` - Checksum
...
**Download:** [v1.2.0 Release](https://github.com/grimm00/dev-infra/releases/tag/v1.2.0)  
