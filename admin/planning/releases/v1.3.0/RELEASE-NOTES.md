...
- `dev-infra-1.3.0.tar.gz` - Clean distribution (Linux/Mac)
- `dev-infra-1.3.0.tar.gz.sha256` - Checksum
- `dev-infra-1.3.0.zip` - Clean distribution (Windows)
- `dev-infra-1.3.0.zip.sha256` - Checksum
...
curl -L https://github.com/grimm00/dev-infra/releases/download/v1.3.0/dev-infra-1.3.0.tar.gz | tar -xz
cd dev-infra-1.3.0
...
curl -L https://github.com/grimm00/dev-infra/releases/download/v1.3.0/dev-infra-1.3.0.tar.gz.sha256 -o dev-infra-1.3.0.tar.gz.sha256
sha256sum -c dev-infra-1.3.0.tar.gz.sha256
```
...
**Download:** [v1.3.0 Release](https://github.com/grimm00/dev-infra/releases/tag/v1.3.0)  
