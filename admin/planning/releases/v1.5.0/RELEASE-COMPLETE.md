...
**Pre-Release:**
- [x] CHANGELOG updated (v1.5.0 entry added)
- [x] Version references updated (v1.4.0 → v1.5.0)
...
**Release Documents:**
- [CHANGELOG.md](../../../../CHANGELOG.md) - v1.5.0 entry
...
**GitHub:**
- **Tag:** [v1.5.0](https://github.com/grimm00/dev-infra/releases/tag/v1.5.0)
- **PR:** [#46](https://github.com/grimm00/dev-infra/pull/46)
- **Comparison:** [v1.4.0...v1.5.0](https://github.com/grimm00/dev-infra/compare/v1.4.0...v1.5.0)
...
**Optional:**
- [ ] Capture release learnings (`/int-opp --release v1.5.0`)
- [ ] Update release retrospective
- [ ] Plan v1.6.0 features

---

**Status:** ✅ **Release complete!** All automation working as expected. v1.5.0 is live! 🚀
