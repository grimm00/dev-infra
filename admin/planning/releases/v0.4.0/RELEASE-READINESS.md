...
| Item | Status | Action |
|------|--------|--------|
| CHANGELOG | ✅ Updated | v0.4.0 section merged |
...
- CHANGELOG updated: ✅ v0.4.0 section merged from draft
...
| Item | Status |
|------|--------|
| Release branch | ✅ Created (`release/v0.4.0`) |
...
- [x] Release branch created (`release/v0.4.0`)
...
7. ✅ Release branch created (`release/v0.4.0`)
...
**Finalized By:** `/release-finalize v0.4.0`
