...
1. Start Group 5 (Documentation & Rules) -- Task 14: Update template workflow documentation.
2. Task 15: Update planning hub documentation in templates.
3. Task 16: Update `.cursor/rules/*.mdc` to reflect new structure.
