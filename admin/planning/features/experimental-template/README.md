...
|-------|--------|-------------|
| Phase 1 | 🔴 Not Started | Create experimental-project template |
| Phase 2 | 🔴 Not Started | Update generator script |
| Phase 3 | 🔴 Not Started | Add CI drift detection |
| Phase 4 | 🔴 Not Started | Add stability indicators |
...
2. Begin Phase 1: Create Template
3. Use `/task-phase 1` to implement
