...
Additionally:
4. **Command Improvement Organization** - Consolidate `*-two-mode` features
...
1. Use `/research explore-two-mode --conduct --topic-num 1` to research Command Improvement Organization
2. Continue with topics 2-6
3. Review requirements in `requirements.md`
4. Use `/decision explore-two-mode --from-research` to make decisions
