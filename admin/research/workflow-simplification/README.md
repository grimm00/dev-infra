...
- **[Topic 6: Dev-Infra Code Boundary](topic-6-dev-infra-code-boundary.md)** - Executable scripts vs. specs-only boundary (🔴 Not Started)

### Summary & Requirements

- **[Research Summary](research-summary.md)** - Synthesis of all findings
- **[Requirements](requirements.md)** - Requirements discovered during research

### Related

- **[Exploration Hub](../../explorations/workflow-simplification/README.md)** - Parent exploration
- **[Research Topics](../../explorations/workflow-simplification/research-topics.md)** - All 6 topics and workflow

---

## 🎯 Overview

Research for the Workflow Simplification exploration. Topics investigate whether the feature/phase/task hierarchy can be simplified given the draft PR workflow (1 PR per feature) and spike-driven decisions.

**Research Order:** Topic 5 → Topic 1 → Topic 2 → Topic 3 → Topic 4 → Topic 6
...
| Topic 6: Dev-Infra Code Boundary | 🔴 Not Started | [topic-6-dev-infra-code-boundary.md](topic-6-dev-infra-code-boundary.md) |

---

**Last Updated:** 2026-02-14  
**Status:** 🟠 In Progress  
**Next:** Conduct Topic 6, then `/decision workflow-simplification --from-research`
